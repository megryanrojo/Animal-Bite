describe('User Submit Report Tests', () => {
  beforeEach(() => {
    cy.visit('/src/user/submit_report.php')
  })

  describe('Submit Report Page Layout', () => {
    it('should display the submit report page correctly', () => {
      cy.get('h1').should('contain', 'Submit Report')
    ...
    it('should display page header', () => {
      ...
      cy.get('.page-header h1').should('contain', 'Submit Report')
      cy.get('.page-header p').should('contain', 'Please fill out all required fields')
    })
  ...
  describe('Submit Report Form', () => {
    it('should display submit report form', () => {
      cy.get('form').should('be.visible')
  ...
  describe('Performance', () => {
    it('should load submit report page within acceptable time', () => {
      cy.measurePageLoad()
    })
