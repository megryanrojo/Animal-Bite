describe('Complete Animal Bite Workflow Integration Tests', () => {
  describe('End-to-End User Journey', () => {
    it('should complete the full animal bite reporting workflow', () => {
      // Step 1: User visits homepage and submits a report
      ...
      cy.get('.modal-body').should('contain', 'Dog')
      ...
      // Step 5: Admin views the patient information
  ...
  describe('Cross-User Workflow', () => {
    it('should handle multiple users working on the same report', () => {
      ...
      // Step 2: Staff 1 logs in and views the report
      cy.loginAsStaff()
      cy.visit('/src/staff/reports.php')
      cy.get('button[data-bs-target*="view"]').first().click()
      cy.get('.modal').should('be.visible')
      ...
      // Step 3: Staff 1 edits the report
      cy.get('button[data-bs-target*="edit"]').first().click()
      cy.get('.modal').should('be.visible')
      ...
      // Step 4: Admin logs in and views the updated report
      cy.loginAsAdmin()
      cy.visit('/src/admin/view_reports.php')
      cy.get('button[data-bs-target*="view"]').first().click()
      cy.get('.modal').should('be.visible')
      ...
      // Step 5: Admin updates the report
      cy.get('button[data-bs-target*="edit"]').first().click()
      cy.get('.modal').should('be.visible')
      ...
      // Step 6: Staff logs back in and sees the updated report
      cy.loginAsStaff()
      cy.visit('/src/staff/reports.php')
      cy.get('button[data-bs-target*="view"]').first().click()
      cy.get('.modal').should('be.visible')
