describe('User Report Page Tests', () => {
  beforeEach(() => {
    cy.visit('/src/user/report.php')
  })

  describe('Report Page Layout', () => {
    it('should display the report page correctly', () => {
      cy.get('h1').should('contain', 'Report an Animal Bite')
    ...
    it('should display page header', () => {
      ...
      cy.get('.page-header h1').should('contain', 'Report an Animal Bite')
  ...
  describe('Performance', () => {
    it('should load report page within acceptable time', () => {
      cy.measurePageLoad()
    })
