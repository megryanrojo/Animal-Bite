...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2025 at 03:29 AM
...
CREATE TABLE `notifications` (
  ...
  `recipient_role` enum('admin','staff','all') NOT NULL DEFAULT 'admin',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `notifications` (`id`, `title`, `message`, `type`, `icon`, `link`, `is_read`, `recipient_id`, `recipient_role`, `created_at`, `updated_at`, `expires_at`) VALUES
(6, 'Welcome to the Admin Dashboard', 'This is your notification center where you can see important alerts and updates.', 'info', 'info-circle', NULL, 1, NULL, 'admin', '2025-05-20 01:26:05', '2025-05-20 03:04:40', NULL),
(7, 'New Animal Bite Report', 'A new animal bite report has been submitted for patient: John Doe', 'info', 'file-medical', 'view_report.php?id=1', 1, NULL, 'admin', '2025-05-20 01:26:05', '2025-05-20 03:04:40', NULL),
(8, 'Critical Case Alert', 'A critical animal bite case (Category III) has been reported for patient: Jane Smith', 'danger', 'exclamation-circle', 'view_report.php?id=2', 1, NULL, 'admin', '2025-05-20 01:26:05', '2025-05-20 03:04:40', NULL);
...
(101, 100, 1, '2025-03-21', '2025-05-21 01:53:03', 'Other', 'Snake', 'Unknown', NULL, NULL, 'Alive', 'Unknown', 'Face', 'Category III', 0, 'Unknown', 1, 0, NULL, 1, '2025-03-21', 0, NULL, 0, NULL, '2025-03-22', NULL, 'pending', '2025-05-21 01:53:03');
...
INSERT INTO `report_images` (`id`, `report_id`, `image_path`, `file_name`, `file_type`, `file_size`, `is_primary`, `description`, `uploaded_at`) VALUES
(1, 2, 'bite_2_681ab9e1589ee.jpg', 'dogbite.jpg', 'image/jpeg', 5177, 1, NULL, '2025-05-07 01:39:45');
...
--
ALTER TABLE `reports`
  MODIFY `reportId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
--
ALTER TABLE `report_images`
  ADD CONSTRAINT `report_images_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `reports` (`reportId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
